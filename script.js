var i18n = {
  en: {
    ...
    p6_tag: "Custom Linux Desktop Environment",
    p6_sect1_label: "Overview",
    p6_sect1: `My personal custom Linux desktop environment tailored to my personal taste and workflow. It's built around a tiling window manager, with a strong focus on workspaces and keyboard shortcuts for a lightning-fast workflow. It also features a custom-made desktop UI for things like the taskbar, alongside a modern, customized Zsh setup for efficient command-line usage.`,
    p6_sect2_label: "Technical Details",
    p6_sect2:
      "The desktop is built around the tiling window manager Hyprland. Quickshell provides the custom desktop UI, including the taskbar and other system components, while Fuzzel handles application launching. KDE/Qt applications such as Dolphin, Kate, and Ark are used as the primary file manager, text editor, and archive manager, with GTK, Qt, and Kvantum configurations providing consistent theming across applications. The setup also includes Neovim for development, a customized Zsh environment with Oh My Posh for command-line usage, and custom shell scripts for automation and system integration.",
    link_source: "source",
    link_github: "GitHub",
  ...
  de: {
    ...
    p6_tag: "Eigene Linux-Desktop-Umgebung",
    p6_sect1_label: "Übersicht",
    p6_sect1: `Meine persönliche Linux-Desktop-Umgebung, abgestimmt auf meinen persönlichen Geschmack und Workflow. Sie basiert auf einem Tiling Window Manager und legt großen Wert auf die Nutzung von Workspaces und Tastenkürzeln für einen schnellen und effizienten Workflow. Außerdem verfügt sie über eine selbst entwickelte Desktop-Oberfläche, unter anderem für die Taskleiste, sowie eine moderne, individuell konfigurierte Zsh-Umgebung für eine effiziente Nutzung der Kommandozeile.`,
    p6_sect2_label: "Technische Details",
    p6_sect2:
      "Das System basiert auf dem Tiling Window Manager Hyprland. Quickshell stellt die individuell entwickelte Desktop-Oberfläche bereit, darunter die Taskleiste und weitere Systemkomponenten, während Fuzzel als App-Launcher dient. KDE/Qt-Anwendungen wie Dolphin, Kate und Ark werden als primärer Dateimanager, Texteditor und Archivmanager verwendet. Konfigurationen für GTK, Qt und Kvantum sorgen dabei für ein einheitliches Erscheinungsbild der Anwendungen. Zusätzlich umfasst das Setup Neovim für die Entwicklung, eine individuell konfigurierte Zsh-Umgebung mit Oh My Posh für die Kommandozeile sowie eigene Shell-Skripte für Automatisierung und Systemintegration.",
