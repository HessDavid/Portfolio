var i18n = {
  en: {
    ...
    p3_sect1: `My first real audio plugin, built before I understood most of the constraints that matter for real-time audio. It taught me why allocations on the audio thread are a bad idea, the hard way.`,
    p3_sect2_label: "Hoonest reflection",
    p3_sect2: `It works, and people have used it, but the UI code is a mess and the CPU usage is higher than it should be. I keep it around unpolished on purpose — it's a useful reminder of where I started.`,
  ...
  de: {
    ...
    p3_sect1: `Mein erstes richtiges Audio-Plugin, gebaut bevor ich die meisten Einschränkungen verstanden hatte, die bei Echtzeit-Audio wichtig sind. Es hat mir auf die harte Tour beigebracht, warum Allokationen im Audio-Thread eine schlechte Idee sind.`,
    p3_sect2_label: "ehrliche Reflexion",
    p3_sect2: `Es funktioniert, und Leute haben es benutzt, aber der UI-Code ist unaufgeräumt und die CPU-Last höher als sie sein sollte. Ich lasse es absichtlich unpoliert — eine nützliche Erinnerung daran, wo ich angefangen habe.`,
